...
<head>
    <!-- META SECTION -->
    <title>Titik Akses - Admin Panel</title>
...
<body onload="getAssignLocationData()">
    ...
    <div class="page-container">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Titik Akses</li>
        </ul>
        <!-- END BREADCRUMB -->
        ...
        <div class="page-content-wrap container">
            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                <i class="fa fa-location-arrow"></i> Detail Titik Akses
                <span style="float:right;margin-right:10px;">
                    <a href="javascript:void(0)" onclick="window.open('./addAssignLocation.php','_blank')" class="text-decoration:none;" title="Tambah Titik Akses" data-toggle="tooltip" data-placement="bottom">
