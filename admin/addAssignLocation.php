...
<body>
    ...
    <div class="page-container">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Tambah Titik Akses</li>
        </ul>
        <!-- END BREADCRUMB -->
        ...
        <div class="page-content-wrap container">
            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                <i class="fa fa-plus"></i> Tambah Titik Akses
            </span>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <!--location id -->
                                    <label>Batas Jarak (Meter):</label>
                                    <input type="number" name="distance_limit" id="distance_limit" class="form-control" placeholder="Batas Jarak Dalam Meter" required>
                                </div>
                            </div>
                            <!--col1 inside row---->
