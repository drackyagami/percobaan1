...
<head>
    <!-- META SECTION -->
    <title>Tambah Izin Baru - Panel Pegawai</title>
...
<body>
    ...
    <div class="page-container">
        ...
        <ul class="breadcrumb">
            ...
            <li class="./messages.php"><a href="./messages.php">Izin</a></li>
            <li class="active">Tambah Izin Baru</li>
        </ul>
        <!-- END BREADCRUMB -->
        ...
        <div class="page-content-wrap container">
            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                <i class="fa fa-paper-plane"></i> Tambah Izin Baru
            </span>
            <div class="row">
                <!---row--->
                <div class="col-md-12">
                    ...
                    <div id="content" style="width:400px;">
                        <form action="" method="post">
                            ...
                            <textarea name="message" id="message" class="form-control" cols="30" rows="10" placeholder="Isi Keterangan..." required></textarea>
                            <br>
                            <center>
