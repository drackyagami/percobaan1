...
<body onload="getAssignLocationRecord()">
    ...
    <div class="page-container">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="./geofencing.php">Titik Akses</a></li>
            <li class="active">Edit Titik Akses</li>
        </ul>
        <!-- END BREADCRUMB -->
        ...
        <div class="page-content-wrap container">
            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                <i class="fa fa-edit"></i> Edit Titik Akses
            </span>
        ...
        ?>
                <script>
                    alertify.success("<span style='color:#fff;font-size:15px;'><i class='fa fa-check-circle'></i> Data Sukses Diubah!</span>");
                </script>
            <?php
            } else {
            ?>
                <script>
                    alertify.error("<span style='color:#fff;font-size:15px;'><i class='fa fa-warning'></i> Data Gagal Diubah!</span>");
                </script>
        <?php
            }
        } #isset  
