...
<div class="page-sidebar">
    ...
    <ul class="x-navigation" style="color:#111;height:100vh">
        ...
        <li>
            <a href="./attendanceMark.php" accesskey="A"><span class="fa fa-check"></span> <span class="xn-text">Absensi</span></a>
        </li>

        <li class="xn-openable">
            <a href="#"><span class="fa fa-list-alt"></span> <span class="xn-text">Data Kehadiran</span></a>
            <ul>
                <li><a href="./todayAttendance.php"><span class="fa fa-calendar-o"></span>Hari Ini</a></li>
                ...
                <li><a href="./periodAttendance.php"><span class="fa fa-calendar-o"></span>Selama Periode Tertentu</a></li>
            </ul>
        </li>
        ...
        <li>
            <a href="editProfile.php" accesskey="P"><span class="fa fa-edit"></span> <span class="xn-text">Edit Profil</span></a>
        </li>
        <li>
            <a href="changePassword.php" accesskey="C"><span class="fa fa-lock"></span><span class="xn-text">Ganti Password</span></a>
        </li>
        <li>
            <a><span class="fa"></span><span class="xn-text"> </span></a>
        </li>
        <li>
            <a><span class="fa"></span><span class="xn-text"> </span></a>
        </li>
