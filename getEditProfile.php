                 ...
                 <div class="col-md-6">
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-12">
                             ...
                             <div class="form-group">
                                 <label>Bidang:</label>
                                 <input type="text" name="emp_position" id="emp_position" value="<?php echo $row['emp_position'] ?>" class="form-control" placeholder="Bidang" required>
                             </div>
                         </div>
                         <!--col3 inside row---->
                         ...
                         <div class="col-md-12">
                             ...
                             <div class="form-group">
                                 ...
                                 <input type="tel" name="emp_mobile" id="emp_mobile" value="<?php echo $row['emp_mobile'] ?>" class="form-control" placeholder="Nomor HP" required>
                             </div>
                         </div>
                         <!--col3 inside row---->
