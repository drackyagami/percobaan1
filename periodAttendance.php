...
<head>
    <!-- META SECTION -->
    <title>Detail Kehadiran Periode Tertentu - Panel Pegawai</title>
...
<body>
    ...
    <div class="page-container">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Periode Tertentu</li>
        </ul>
        <!-- END BREADCRUMB -->
        ...
        <div class="page-content-wrap container">
            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                <i class="fa fa-calendar"></i> Detail Kehadiran Periode Tertentu
            </span>
            <div class="row">
                <!---row--->
                <div class="col-md-12">
